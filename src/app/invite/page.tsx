...
export default function InvitePage() {
    ...
    const inviteLink = 'https://localhost:3000/invite/19292'
                ...
                <div className='space-y-6'>
                    <div className='space-y-3'>
                        ...
                        <p className='text-gray-300'>
                            Convide mais pessoas para o evento e concorra a prêmios exclusivos! É só compartilhar o link e acompanhar as incrições:
                        </p>
                    </div>
