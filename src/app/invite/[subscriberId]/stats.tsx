import { getSubscriberInviteClicks, getSubscriberInviteCount, getSubscriberRankingPosition } from "@/https/api";
...
export async function Stats({ subscriberId }: StatsProps) {
    ...
    const { count: invitCount } = await getSubscriberInviteCount(subscriberId)
